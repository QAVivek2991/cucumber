...
public class LoginSteps {
	...
	public void verify_placeholder_of_email_and_password_field() {
		System.out.print(loginPage.getEmailPlaceholder());
		Assert.assertEquals("Email placeholder not correct", loginPage.getEmailPlaceholder(), "");
		Assert.assertEquals("Password placeholder not correct", loginPage.getPasswordPlaceholder(), "");
